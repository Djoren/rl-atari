...
# NOTE: will cause retracing as we're passing different python args
#       This should however be limited to a few cases only; one for each layer.
#       W/o the tf.function is causes memory leak in 2.13.0, seems not be the case in 2.12.1.
@tf.function
